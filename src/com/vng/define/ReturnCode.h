...
#define RESPONSE_ZING_ID_ALREADY_USED 					 71
#define RESPONSE_ZING_AUTHENTICATE_FAIL 					 72
#define RESPONSE_MISMATCH_SESSION 					 73

#define RESPONSE_LEVEL_UP_FAILED 					 74

#define RESPONSE_AUTHENTICATE_GIFT_CODE_FAILED 					 75
#define RESPONSE_INVALID_GIFT_CODE_SIZE 					 76
#define RESPONSE_GIFT_CODE_NOT_EXISTED 					 77
#define RESPONSE_GIFT_CODE_ENTER_LIMITED 					 78

#define RESPONSE_SERVER_OVERLOADED 					 79
#define RESPONSE_SERVER_MAINTAIN 					 80
#define RESPONSE_MISMATCH_UID 					 81

#define RESPONSE_PHONE_NUMBER_ALREADY_USED 					 82
#define RESPONSE_ALREADY_LINKED_PHONE_NUMBER 					 83

#define RESPONSE_ITEM_IS_NOT_FOR_SALED 					 84
#define RESPONSE_UPGRADE_POT_BLESSING 					 85

#define RESPONSE_GIFT_CODE_HAD_BEEN_RECEIVED 					 86
#define RESPONSE_GIFT_CODE_OUT_OF_DATE 					 87
#define RESPONSE_GIFT_TYPE_HAD_BEEN_RECEIVED 					 88
#define RESPONSE_AUTHENTICATE_GIFT_CODE_OK 					 89
#define RESPONSE_GIFT_CODE_FOR_FRIEND 					 90

#define RESPONSE_ALREADY_LIKED_GARDEN 					 91
#define RESPONSE_REQUIRE_FACEBOOK_LOGIN 					 92
#define RESPONSE_EMPTY_RANKING_INFO 					 93

#define RESPONSE_ZALO_ID_ALREADY_USED 					 94
#define RESPONSE_ZALO_AUTHENTICATE_FAIL 					 95

#define RESPONSE_AIRSHIP_ASK_FOR_HELP_FULL 					 96

#define RESPONSE_ROOM_FULL 					 97
#define RESPONSE_INVALID_ROOM 					 98

#define RESPONSE_MULTIPLE_LOGIN 					 99
#define RESPONSE_FORCE_QUIT 					 100
