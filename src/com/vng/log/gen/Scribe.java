...
public class Scribe {
  ...
  public static class AsyncClient extends FacebookService.AsyncClient implements AsyncIface {
    ...
    public void Log(List<LogEntry> messages, org.apache.thrift.async.AsyncMethodCallback<Log_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      Log_call method_call = new Log_call(messages, resultHandler, this, this.___protocolFactory, this.___transport);
  ...
  public static class Processor extends FacebookService.Processor implements org.apache.thrift.TProcessor {
